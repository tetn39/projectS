...
SECRET_KEY = 'django-insecure-f0xlx)**si+9c1%lvu)%6fu0+3cyo23@0(vjy84+pq=&1pls*^'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            # Path: projects\projects\templates
...
LOGIN_REDIRECT_URL = '/melotus/login/'
LOGOUT_REDIRECT_URL = '/melotus/'
